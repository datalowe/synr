...
* Visualization of individual participants' data with a type of [ggplot2](https://ggplot2.tidyverse.org/) plots, tailored for this purpose.
  + These plots are useful for quick visual inspection of participants' responses. This might aid in identifying unusual response patterns that need to be inspected further, or that indicate that a participant has erroneously been classified as (not) having synesthetic associations.
