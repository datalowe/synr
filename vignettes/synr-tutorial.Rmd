...
propred_digits_pH <- pg_large$participants[['partA']]$get_prop_color(color_label = 'red',
...
AZ_09_filter <- build_grapheme_vector(language='english',
                                      use_digits=TRUE,
                                      use_letters=TRUE)
cscores_AZ_09 <- pg_large$get_mean_consistency_scores(symbol_filter=AZ_09_filter)
print(cscores_AZ_09)
